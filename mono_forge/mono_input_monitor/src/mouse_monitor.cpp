...
MONO_INPUT_MONITOR_API bool mono_input_monitor::GetButton(MouseInputState &state, MouseCode mouseCode)
{
...
MONO_INPUT_MONITOR_API bool mono_input_monitor::GetButtonDown(MouseInputState &state, MouseCode mouseCode)
{
    if (mouseCode == MouseCode::Null || mouseCode == MouseCode::Size)
        riaecs::NotifyError({"Invalid mouse code"}, RIAECS_LOG_LOC);
...
MONO_INPUT_MONITOR_API bool mono_input_monitor::GetButtonUp(MouseInputState &state, MouseCode mouseCode)
{
    if (mouseCode == MouseCode::Null || mouseCode == MouseCode::Size)
        riaecs::NotifyError({"Invalid mouse code"}, RIAECS_LOG_LOC);
...
MONO_INPUT_MONITOR_API bool mono_input_monitor::GetButtonDoubleTap(MouseInputState &state, MouseCode mouseCode, double threshold)
{
    if (mouseCode == MouseCode::Null || mouseCode == MouseCode::Size)
        riaecs::NotifyError({"Invalid mouse code"}, RIAECS_LOG_LOC);
