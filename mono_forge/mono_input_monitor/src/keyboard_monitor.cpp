...
(
    ...
    if (inputType == InputType::None || keyCode == KeyCode::Null)
        riaecs::NotifyError({"Invalid input type or key code in EditInputState"}, RIAECS_LOG_LOC);
...
MONO_INPUT_MONITOR_API bool mono_input_monitor::GetKeyDown(KeyboardInputState &state, KeyCode keyCode)
{
    if (keyCode == KeyCode::Null || keyCode == KeyCode::Size)
        riaecs::NotifyError({"Invalid key code"}, RIAECS_LOG_LOC);
...
MONO_INPUT_MONITOR_API bool mono_input_monitor::GetKeyUp(KeyboardInputState &state, KeyCode keyCode)
{
    if (keyCode == KeyCode::Null || keyCode == KeyCode::Size)
        riaecs::NotifyError({"Invalid key code"}, RIAECS_LOG_LOC);
...
MONO_INPUT_MONITOR_API bool mono_input_monitor::GetKeyDoubleTap(KeyboardInputState &state, KeyCode keyCode, double threshold)
{
    if (keyCode == KeyCode::Null || keyCode == KeyCode::Size)
        riaecs::NotifyError({"Invalid key code"}, RIAECS_LOG_LOC);
