...
namespace mono_input_monitor
{
    ...
    MONO_INPUT_MONITOR_API bool GetKey(KeyboardInputState& state, KeyCode keyCode);
    MONO_INPUT_MONITOR_API bool GetKeyDown(KeyboardInputState& state, KeyCode keyCode);
    MONO_INPUT_MONITOR_API bool GetKeyUp(KeyboardInputState& state, KeyCode keyCode);
    MONO_INPUT_MONITOR_API bool GetKeyDoubleTap(KeyboardInputState& state, KeyCode keyCode, double threshold = 0.3);
