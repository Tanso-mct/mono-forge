...
namespace mono_input_monitor
{
    ...
    MONO_INPUT_MONITOR_API bool GetButton(MouseInputState &state, MouseCode mouseCode);
    MONO_INPUT_MONITOR_API bool GetButtonDown(MouseInputState &state, MouseCode mouseCode);
    MONO_INPUT_MONITOR_API bool GetButtonUp(MouseInputState &state, MouseCode mouseCode);
    MONO_INPUT_MONITOR_API bool GetButtonDoubleTap(MouseInputState &state, MouseCode mouseCode, double threshold = 0.3);
